...
/* harmony import */ var _services_variables__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/variables */ "./src/js/services/variables.js");
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  _services_variables__WEBPACK_IMPORTED_MODULE_6__["stylesLink"].forEach((item, i) => {
    item.addEventListener("mouseover", () => {
      _services_variables__WEBPACK_IMPORTED_MODULE_6__["stylesImg"][i].classList.add("show");
    });
    item.addEventListener("mouseout", () => {
      _services_variables__WEBPACK_IMPORTED_MODULE_6__["stylesImg"][i].classList.remove("show");
    });
  });
});
