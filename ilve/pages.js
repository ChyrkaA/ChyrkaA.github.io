...
function cookies() {
  (0,_services_cookieconsent_esm_js__WEBPACK_IMPORTED_MODULE_0__.run)({
    guiOptions: {
      consentModal: {
        layout: "box",
      ...
      translations: {
        pl: {
          consentModal: {
            ...
            description: "Strona <strong>Inewera Sp. z o.o.</strong> wykorzystuje niezbędne pliki cookie w celu zapewnienia jej prawidłowego działania. Pozostałe pliki cookie zostaną aktywowane wyłącznie po wyrażeniu przez Ciebie zgody.",
          ...
          preferencesModal: {
            ...
            sections: [{
              ...
              description: 'Administratorem Twoich danych jest <strong>Inewera Sp. z o.o.</strong>. Używamy plików cookie, aby zapewnić podstawowe funkcje witryny i poprawić komfort użytkowania. Więcej informacji znajdziesz w naszej <a href="polityka.html" class="cc-link">Polityce Prywatności</a>.'
            }, {
              ...
              description: "W przypadku pytań dotyczących naszych zasad korzystania z plików cookie, prosimy o kontakt poprzez formularz na stronie, lub skontaktuj się z nami: <br><strong>Inewera Sp. z o.o. <br> e-mail: inewera.pl@gmail.com <br> <a href='https://www.inewera.pl'>www.inewera.pl</a></strong>."
            }]
          },
          guiOptions: {
            consentModal: {
  ...
  document.addEventListener("click", e => {
    ...
    if (btn) {
      e.preventDefault();
      (0,_services_cookieconsent_esm_js__WEBPACK_IMPORTED_MODULE_0__.showPreferences)(); // Виклик вікна налаштувань
    }
  });
}
...
/* harmony import */ var _modules_coockies_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/coockies.js */ "./src/js/modules/coockies.js");
...
window.addEventListener("DOMContentLoaded", () => {
  (0,_modules_coockies_js__WEBPACK_IMPORTED_MODULE_7__["default"])();
