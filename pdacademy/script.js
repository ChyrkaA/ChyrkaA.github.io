...
/* harmony import */ var _modules_promo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/promo.js */ "./src/js/modules/promo.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
function cursesBlock(containerBtn, btn, lineOne, lineTwo, activeStyle, activeContent, activeLine1, activeLine2) {
  const parentBtns = document.querySelector(containerBtn);
  parentBtns.addEventListener('click', e => {
    const btns = e.target.closest(btn);
    if (btns) {
      const line1 = btns.querySelector(lineOne);
      const line2 = btns.querySelector(lineTwo);
      btns.classList.toggle(activeStyle);
      btns.nextElementSibling.classList.toggle(activeContent);
      ...
      if (btns.classList.contains(activeStyle)) {
        if (window.innerWidth < 768) {
          ...
          btns.nextElementSibling.style.maxHeight = '475px';
        }
      } else {
        btns.nextElementSibling.style.maxHeight = '0px';
      }
    }
  });
}
/* harmony default export */ __webpack_exports__["default"] = (cursesBlock);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/swiper-bundle.min */ "./src/js/services/swiper-bundle.min.js");

function swiperBlock(trigger, pagination) {
  const swiper = new _services_swiper_bundle_min__WEBPACK_IMPORTED_MODULE_0__["Swiper"](trigger, {
    slidesPerView: 'auto',
    centeredSlides: true,
    roundLengths: true,
    loop: true,
...
/* harmony default export */ __webpack_exports__["default"] = (swiperBlock);
...
/***/ "./src/js/services/swiper-bundle.min.js":
/*!**********************************************!*\
  !*** ./src/js/services/swiper-bundle.min.js ***!
  \**********************************************/
...
function calcDevice(e) {
  ...
  const p = r.match(/(iPod)(.*OS\s([\d_]+))?/),
    ...
    m = "Win32" === i;
  let f = "MacIntel" === i;
  return !c && f && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >= 0 && (c = r.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), f = !1), d && !m && (n.os = "android", n.android = !0), (c || u || p) && (n.os = "ios", n.ios = !0), n;
}
...
function updateSlides() {
  ...
  let y = a.spaceBetween,
    ...
    x = 0;
  if (void 0 === n) return;
  "string" == typeof y && y.indexOf("%") >= 0 ? y = parseFloat(y.replace("%", "")) / 100 * n : "string" == typeof y && (y = parseFloat(y)), e.virtualSize = -y, p.forEach(e => {
  ...
  const C = "auto" === a.slidesPerView && a.breakpoints && Object.keys(a.breakpoints).filter(e => void 0 !== a.breakpoints[e].slidesPerView).length > 0;
  for (let i = 0; i < u; i += 1) {
    let r;
    if (M = 0, p[i] && (r = p[i]), T && e.grid.updateSlide(i, r, u, t), !p[i] || "none" !== elementStyle(r, "display")) {
      if ("auto" === a.slidesPerView) {
        C && (p[i].style[t("width")] = "");
        const n = getComputedStyle(r),
          l = r.style.transform,
          o = r.style.webkitTransform;
        if (l && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), a.roundLengths) M = e.isHorizontal() ? elementOuterSize(r, "width", !0) : elementOuterSize(r, "height", !0);else {
          const e = s(n, "width"),
            t = s(n, "padding-left"),
            a = s(n, "padding-right"),
            i = s(n, "margin-left"),
          ...
          if (o && "border-box" === o) M = e + i + l;else {
            const {
              clientWidth: s,
              offsetWidth: n
            } = r;
        ...
        l && (r.style.transform = l), o && (r.style.webkitTransform = o), a.roundLengths && (M = Math.floor(M));
      } else M = (n - (a.slidesPerView - 1) * y) / a.slidesPerView, a.roundLengths && (M = Math.floor(M)), p[i] && (p[i].style[t("width")] = `${M}px`);
  ...
  if (e.virtualSize = Math.max(e.virtualSize, n) + v, l && o && ("slide" === a.effect || "coverflow" === a.effect) && (i.style.width = `${e.virtualSize + y}px`), a.setWrapperSize && (i.style[t("width")] = `${e.virtualSize + y}px`), T && e.grid.updateWrapperSize(M, m, t), !a.centeredSlides) {
    const t = [];
...
const processLazyPreloader = (e, t) => {
  ...
  preload = e => {
    ...
    if (e.params.rewind) for (let a = i - t; a <= r + t; a += 1) {
      const t = (a % s + s) % s;
      t !== i && t > r && unlazy(e, t);
    } else for (let a = Math.max(r - t, 0); a <= Math.min(r + t, s - 1); a += 1) a !== i && a > r && unlazy(e, a);
  };
...
function slideToClickedSlide() {
  ...
  if (t.loop) {
    ...
    i = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - a / 2 || r > e.slides.length - e.loopedSlides + a / 2 ? (e.loopFix(), r = e.getSlideIndex(elementChildren(s, `${n}[data-swiper-slide-index="${i}"]`)[0]), nextTick(() => {
      e.slideTo(r);
    })) : e.slideTo(r) : r > e.slides.length - a ? (e.loopFix(), r = e.getSlideIndex(elementChildren(s, `${n}[data-swiper-slide-index="${i}"]`)[0]), nextTick(() => {
      e.slideTo(r);
    })) : e.slideTo(r);
  } else e.slideTo(r);
}
...
function onTouchMove(e) {
  ...
  if (void 0 === a.isScrolling) {
    let e;
    s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? a.isScrolling = !1 : m * m + f * f >= 25 && (e = 180 * Math.atan2(Math.abs(f), Math.abs(m)) / Math.PI, a.isScrolling = s.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle);
  }
  ...
  if (i.touchReleaseOnEdges && (E = 0), h > 0 ? (w && !b && a.currentTranslate > (i.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
    ...
    setTranslate: !0,
    activeSlideIndex: 0
  }), a.currentTranslate > s.minTranslate() && (y = !1, i.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + h) ** E))) : h < 0 && (w && !b && a.currentTranslate < (i.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
    direction: "next",
    setTranslate: !0,
...
function onTouchEnd(e) {
  ...
  for (let e = 0; e < l.length; e += e < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
    ...
    void 0 !== l[e + t] ? u >= l[e] && u < l[e + t] && (m = e, f = l[e + t] - l[e]) : u >= l[e] && (m = e, f = l[l.length - 1] - l[l.length - 2]);
  }
  let h = null,
    g = null;
...
class Swiper {
  constructor() {
    ...
    1 === a.length && a[0].constructor && "Object" === Object.prototype.toString.call(a[0]).slice(8, -1) ? t = a[0] : [e, t] = a, t || (t = {}), t = extend({}, t), e && !t.el && (t.el = e);
    const r = getDocument();
    ...
    return n.params = extend({}, o, extendedDefaults, t), n.originalParams = extend({}, n.params), n.passedParams = extend({}, t), n.params && n.params.on && Object.keys(n.params.on).forEach(e => {
  ...
  getSlideIndex(e) {
    const {
      ...
      a = elementIndex(elementChildren(t, `.${s.slideClass}, swiper-slide`)[0]);
  ...
  mount(e) {
    ...
    return !i && t.params.createElements && (i = createElement("div", t.params.wrapperClass), s.append(i), elementChildren(s, `.${t.params.slideClass}`).forEach(e => {
      i.append(e);
    })), Object.assign(t, {
      el: s,
      wrapperEl: i,
...
function Virtual(e) {
  ...
  function d(e) {
    ...
    if (n && h >= w ? (b -= w, i || (E += s.slidesGrid[0])) : n && h < w && (b = -w, i && (E += s.slidesGrid[0])), Object.assign(s.virtual, {
      ...
      slidesBefore: w,
      slidesAfter: v
    }), c === b && p === y && !e) return s.slidesGrid !== m && E !== f && s.slides.forEach(e => {
    ...
    if (e) s.slidesEl.querySelectorAll(`.${s.params.slideClass}, swiper-slide`).forEach(e => {
      e.remove();
    });else for (let e = c; e <= p; e += 1) if (e < b || e > y) {
      const t = M(e);
    ...
    if (h >= t.minTranslate() && (h = t.minTranslate()), h <= t.maxTranslate() && (h = t.maxTranslate()), a = !!t.params.loop || !(h === t.minTranslate() || h === t.maxTranslate()), a && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
      ...
      if (!a) {
        ...
        const c = t.isBeginning,
          u = t.isEnd;
        if (o >= t.minTranslate() && (o = t.minTranslate()), o <= t.maxTranslate() && (o = t.maxTranslate()), t.setTransition(0), t.setTranslate(o), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!c && t.isBeginning || !u && t.isEnd) && t.updateSlidesClasses(), t.params.loop && t.loopFix({
          ...
          const s = d.length ? d[d.length - 1] : void 0,
            a = d[0];
          if (d.push(e), s && (e.delta > s.delta || e.direction !== s.direction)) d.splice(0);else if (d.length >= 15 && e.time - a.time < 500 && a.delta - e.delta >= 1 && e.delta <= 6) {
            const s = p > 0 ? .8 : .2;
...
function Pagination(e) {
  ...
  function p(e) {
    const s = e.target.closest(classesToSelector(t.params.pagination.bulletClass));
    if (!s) return;
    e.preventDefault();
  ...
  function u() {
    ...
    if (t.params.loop ? (r = t.previousRealIndex || 0, a = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (a = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, a = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
      ...
      let o, d, u;
      if (s.dynamicBullets && (n = elementOuterSize(i[0], t.isHorizontal() ? "width" : "height", !0), p.forEach(e => {
    ...
    p.forEach((e, r) => {
      if ("fraction" === s.type && (e.querySelectorAll(classesToSelector(s.currentClass)).forEach(e => {
        ...
        let n = 1,
          l = 1;
        "horizontal" === i ? n = r : l = r, e.querySelectorAll(classesToSelector(s.progressbarFillClass)).forEach(e => {
  ...
  function m() {
    ...
    "fraction" === e.type && (r = e.renderFraction ? e.renderFraction.call(t, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`), "progressbar" === e.type && (r = e.renderProgressbar ? e.renderProgressbar.call(t, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), t.pagination.bullets = [], a.forEach(s => {
      "custom" !== e.type && (s.innerHTML = r || ""), "bullets" === e.type && t.pagination.bullets.push(...s.querySelectorAll(classesToSelector(e.bulletClass)));
...
function Scrollbar(e) {
  ...
  function m() {
    ...
    let d = l,
      c = (o - l) * n;
    s ? (c = -c, c > 0 ? (d = l - c, c = 0) : -c + l > o && (d = o + c)) : c < 0 ? (d = l + c, c = 0) : c + l > o && (d = o - c), t.isHorizontal() ? (a.style.transform = `translate3d(${c}px, 0, 0)`, a.style.width = `${d}px`) : (a.style.transform = `translate3d(0px, ${c}px, 0)`, a.style.height = `${d}px`), r.hide && (clearTimeout(p), i.style.opacity = 1, p = setTimeout(() => {
  ...
  function b(e) {
    ...
    c && (c = !1, t.params.cssMode && (t.wrapperEl.style["scroll-snap-type"] = "", r.style.transitionDuration = ""), s.hide && (clearTimeout(u), u = nextTick(() => {
...
function Parallax(e) {
  ...
  const i = (e, s) => {
    ...
    r = () => {
      ...
      elementChildren(e, "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").forEach(e => {
        i(e, a);
      }), s.forEach((e, s) => {
        let n = e.progress;
...
function Zoom(e) {
  ...
  function v(e) {
    ...
    if (n = !1, l = !1, c.push(e), !(c.length < 2)) {
      if (n = !0, p.scaleStart = h(), !p.slideEl) {
        ...
        if (a && (a = a.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), p.imageEl = a, p.imageWrapEl = a ? elementParents(p.imageEl, `.${s.containerClass}`)[0] : void 0, !p.imageWrapEl) return void (p.imageEl = void 0);
  ...
  function w(e) {
    ...
    i >= 0 && (c[i] = e), c.length < 2 || (l = !0, p.scaleMove = h(), p.imageEl && (a.scale = p.scaleMove / p.scaleStart * o, a.scale > p.maxRatio && (a.scale = p.maxRatio - 1 + (a.scale - p.maxRatio + 1) ** .5), a.scale < s.minRatio && (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) ** .5), p.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`));
  }
  function b(e) {
    if (!g(e)) return;
    ...
    const s = t.params.zoom,
      a = t.zoom,
      i = c.findIndex(t => t.pointerId === e.pointerId);
    i >= 0 && c.splice(i, 1), n && l && (n = !1, l = !1, p.imageEl && (a.scale = Math.max(Math.min(a.scale, p.maxRatio), s.minRatio), p.imageEl.style.transitionDuration = `${t.params.speed}ms`, p.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`, o = a.scale, d = !1, a.scale > 1 && p.slideEl ? p.slideEl.classList.add(`${s.zoomedSlideClass}`) : a.scale <= 1 && p.slideEl && p.slideEl.classList.remove(`${s.zoomedSlideClass}`), 1 === a.scale && (p.originX = 0, p.originY = 0, p.slideEl = void 0)));
  }
  function y(e) {
    if (!g(e) || !function (e) {
    ...
    const r = (s.scale - o) / (p.maxRatio - t.params.zoom.minRatio),
      {
        originX: n,
        originY: l
      } = p;
  ...
  function S(e) {
    const s = t.zoom,
      a = t.params.zoom;
    if (!p.slideEl) {
      e && e.target && (p.slideEl = e.target.closest(`.${t.params.slideClass}, swiper-slide`)), p.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? p.slideEl = elementChildren(t.slidesEl, `.${t.params.slideActiveClass}`)[0] : p.slideEl = t.slides[t.activeIndex]);
      let s = p.slideEl.querySelector(`.${a.containerClass}`);
      s && (s = s.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), p.imageEl = s, p.imageWrapEl = s ? elementParents(p.imageEl, `.${a.containerClass}`)[0] : void 0;
    }
    if (!p.imageEl || !p.imageWrapEl) return;
    let i, n, l, d, c, m, f, h, g, v, w, b, y, E, S, x, T, M;
    t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), p.slideEl.classList.add(`${a.zoomedSlideClass}`), void 0 === u.touchesStart.x && e ? (i = e.pageX, n = e.pageY) : (i = u.touchesStart.x, n = u.touchesStart.y);
  ...
  function x() {
    const e = t.zoom,
      s = t.params.zoom;
    if (!p.slideEl) {
      t.params.virtual && t.params.virtual.enabled && t.virtual ? p.slideEl = elementChildren(t.slidesEl, `.${t.params.slideActiveClass}`)[0] : p.slideEl = t.slides[t.activeIndex];
      let e = p.slideEl.querySelector(`.${s.containerClass}`);
      e && (e = e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), p.imageEl = e, p.imageWrapEl = e ? elementParents(p.imageEl, `.${s.containerClass}`)[0] : void 0;
    }
    p.imageEl && p.imageWrapEl && (t.params.cssMode && (t.wrapperEl.style.overflow = "", t.wrapperEl.style.touchAction = ""), e.scale = 1, o = 1, p.imageWrapEl.style.transitionDuration = "300ms", p.imageWrapEl.style.transform = "translate3d(0,0,0)", p.imageEl.style.transitionDuration = "300ms", p.imageEl.style.transform = "translate3d(0,0,0) scale(1)", p.slideEl.classList.remove(`${s.zoomedSlideClass}`), p.slideEl = void 0, p.originX = 0, p.originY = 0);
  }
  function T(e) {
    const s = t.zoom;
  ...
  function C() {
    ...
    t.wrapperEl.addEventListener("pointerdown", v, s), t.wrapperEl.addEventListener("pointermove", w, a), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
  ...
  function P() {
    ...
    t.wrapperEl.removeEventListener("pointerdown", v, s), t.wrapperEl.removeEventListener("pointermove", w, a), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
...
function Controller(e) {
  ...
  s({
    ...
    setTransition: function (e, s) {
      ...
      let r;
      function n(s) {
        s.destroyed || (s.setTransition(e, t), 0 !== e && (s.transitionStart(), s.params.autoHeight && nextTick(() => {
          s.updateAutoHeight();
...
function A11y(e) {
  ...
  a("beforeInit", () => {
    ...
    t.params.a11y.enabled && function () {
      ...
      e = n(e), s = n(s), e && e.forEach(e => e.removeEventListener("keydown", f)), s && s.forEach(e => e.removeEventListener("keydown", f)), g() && (Array.isArray(t.pagination.el) ? t.pagination.el : [t.pagination.el]).forEach(e => {
  ...
  s({
    hashNavigation: {
      ...
      getSlideIndex(e, s) {
        ...
        return t.getSlideIndex(elementChildren(t.slidesEl, `.${t.params.slideClass}[data-hash="${s}"], swiper-slide[data-hash="${s}"]`)[0]);
      }
    }
  });
  const o = () => {
    ...
    d = () => {
      ...
      t.params.hashNavigation.replaceState && l.history && l.history.replaceState ? (l.history.replaceState(null, null, `#${s}` || ""), a("hashSet")) : (n.location.hash = s || "", a("hashSet"));
    };
  i("init", () => {
...
function Autoplay(e) {
  ...
  const b = () => {
      ...
      a.autoplay.timeLeft = e, n("autoplayTimeLeft", e, e / h), s = requestAnimationFrame(() => {
        b();
      });
    },
    y = e => {
      ...
      const l = a.params.speed,
        d = () => {
          a && !a.destroyed && (a.params.autoplay.reverseDirection ? !a.isBeginning || a.params.loop || a.params.rewind ? (a.slidePrev(l, !0, !0), n("autoplay")) : a.params.autoplay.stopOnLastSlide || (a.slideTo(a.slides.length - 1, l, !0, !0), n("autoplay")) : !a.isEnd || a.params.loop || a.params.rewind ? (a.slideNext(l, !0, !0), n("autoplay")) : a.params.autoplay.stopOnLastSlide || (a.slideTo(0, l, !0, !0), n("autoplay")), a.params.cssMode && (v = new Date().getTime(), requestAnimationFrame(() => {
            y();
          })));
        };
  ...
  r("init", () => {
    ...
    !a.destroyed && a.autoplay.running && (a.params.autoplay.disableOnInteraction ? S() : (c = !0, p = !1, f = !1, u = setTimeout(() => {
      f = !0, p = !0, x(!0);
    }, 200)));
  }), r("touchEnd", () => {
...
function Thumb(e) {
  ...
  function o(e) {
    ...
    if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (i = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (i = 1), i = Math.floor(i), s.slides.forEach(e => e.classList.remove(r)), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (let e = 0; e < i; e += 1) elementChildren(s.slidesEl, `[data-swiper-slide-index="${t.realIndex + e}"]`).forEach(e => {
      e.classList.add(r);
      ...
      const s = getDocument(),
        a = () => {
          ...
          if (a && a.swiper) e.swiper = a.swiper, l(), o(!0);else if (a) {
            const s = i => {
              e.swiper = i.detail[0], a.removeEventListener("init", s), l(), o(!0), e.swiper.update(), t.update();
            };
      ...
      onTouchEnd: function (e) {
        ...
        if (s < -t.minTranslate()) t.slideTo(t.activeIndex);else if (s > -t.maxTranslate()) t.slides.length < o.length ? t.slideTo(o.length - 1) : t.slideTo(t.slides.length - 1);else {
          if (r.freeMode.momentum) {
            ...
            r.freeMode.momentumBounce && u ? (t.updateProgress(p), t.setTransition(e), t.setTranslate(c), t.transitionStart(!0, t.swipeDirection), t.animating = !0, elementTransitionEnd(n, () => {
              t && !t.destroyed && d.allowMomentumBounce && (a("momentumBounce"), t.setTransition(r.speed), setTimeout(() => {
                t.setTranslate(p), elementTransitionEnd(n, () => {
                  t && !t.destroyed && t.transitionEnd();
                });
              }, 0));
            })) : t.velocity ? (a("_freeModeNoMomentumRelease"), t.updateProgress(c), t.setTransition(e), t.setTranslate(c), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, elementTransitionEnd(n, () => {
              t && !t.destroyed && t.transitionEnd();
    ...
    setTranslate: () => {
      ...
      for (let a = 0; a < e.length; a += 1) {
        ...
        const n = t.params.fadeEffect.crossFade ? Math.max(1 - Math.abs(e.progress), 0) : 1 + Math.min(Math.max(e.progress, -1), 0),
          l = effectTarget(s, e);
        l.style.opacity = n, l.style.transform = `translate3d(${i}px, ${r}px, 0px)`;
      }
    },
    setTransition: e => {
...
function EffectCube(e) {
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      let m,
        f = 0;
      c.shadow && (p ? (m = t.slidesEl.querySelector(".swiper-cube-shadow"), m || (m = createElement("div", "swiper-cube-shadow"), t.slidesEl.append(m)), m.style.height = `${r}px`) : (m = e.querySelector(".swiper-cube-shadow"), m || (m = createElement("div", "swiper-cube-shadow"), e.append(m))));
      for (let e = 0; e < a.length; e += 1) {
        const t = a[e];
        let s = e;
        ...
        let m = 0,
          h = 0,
          g = 0;
        s % 4 == 0 ? (m = 4 * -n * o, g = 0) : (s - 1) % 4 == 0 ? (m = 0, g = 4 * -n * o) : (s - 2) % 4 == 0 ? (m = o + 4 * n * o, g = o) : (s - 3) % 4 == 0 && (m = -o, g = 3 * o + 4 * o * n), l && (m = -m), p || (h = m, m = 0);
        const v = `rotateX(${p ? 0 : -r}deg) rotateY(${p ? r : 0}deg) translate3d(${m}px, ${h}px, ${g}px)`;
        d <= 1 && d > -1 && (f = 90 * s + 90 * d, l && (f = 90 * -s - 90 * d)), t.style.transform = v, c.slideShadows && i(t, d, p);
      }
...
function createShadow(e, t, s) {
  ...
  return r || (r = createElement("div", "swiper-slide-shadow" + (s ? `-${s}` : "")), i.append(r)), r;
}
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let e = 0, t = a.length; e < t; e += 1) {
        ...
        if (effectTarget(r, t).style.transform = b, t.style.zIndex = 1 - Math.abs(Math.round(p)), r.slideShadows) {
          let e = n ? t.querySelector(".swiper-slide-shadow-left") : t.querySelector(".swiper-slide-shadow-top"),
            s = n ? t.querySelector(".swiper-slide-shadow-right") : t.querySelector(".swiper-slide-shadow-bottom");
          e || (e = createShadow(r, t, n ? "left" : "top")), s || (s = createShadow(r, t, n ? "right" : "bottom")), e && (e.style.opacity = p > 0 ? p : 0), s && (s.style.opacity = -p > 0 ? -p : 0);
        }
      }
    },
    setTransition: e => {
      t.slides.map(e => getSlideTransformEl(e)).forEach(t => {
        t.style.transitionDuration = `${e}ms`, t.querySelectorAll(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").forEach(t => {
          t.style.transitionDuration = `${e}ms`;
        });
      });
  ...
  effectInit({
    ...
    setTranslate: () => {
      ...
      for (let s = 0; s < e.length; s += 1) {
        ...
        d < 0 ? (h = r.next, f = !0) : d > 0 && (h = r.prev, f = !0), u.forEach((e, t) => {
    ...
    setTranslate: () => {
      ...
      for (let l = 0; l < e.length; l += 1) {
        ...
        if (a.slideShadows) {
          ...
          e || (e = createShadow(a, o)), e && (e.style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1));
        }
