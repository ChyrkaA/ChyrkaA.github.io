...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_cookieconsent_esm_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/cookieconsent.esm.js */ "./src/js/services/cookieconsent.esm.js");

function cookies() {
  Object(_services_cookieconsent_esm_js__WEBPACK_IMPORTED_MODULE_0__["run"])({
    guiOptions: {
      consentModal: {
        layout: "box",
      ...
      translations: {
        pl: {
          ...
          preferencesModal: {
            ...
            savePreferencesBtn: "Zapisz zaznaczenie",
            closeIconLabel: "Zamknij",
            sections: [{
              title: "Wykorzystanie plików cookie",
              description: 'Administratorem Twoich danych jest <strong>Sunny Isles sp zoo Polska</strong>. Używamy plików cookie, aby zapewnić podstawowe funkcje witryny i poprawić komfort użytkowania. Więcej informacji znajdziesz w naszej <a href="polityka.html" class="cc-link">Polityce Prywatności</a>.'
            }, {
              title: "Czym są pliki cookies?",
              description: "Cookies to niewielkie pliki tekstowe zapisywane na urządzeniu użytkownika podczas korzystania ze strony internetowej.."
            }, {
              title: "Niezbędne pliki cookie (Wymagane)",
              description: "Te pliki cookie są niezbędne do bezpiecznego i prawidłowego działania strony. Są one używane m.in. do obsługi formularza kontaktowego oraz zapamiętywania Twoich ustawień prywatności.",
              linkedCategory: "necessary"
            }, {
              title: "Jakie cookies wykorzystujemy?",
              description: "<p>Strona może wykorzystywać:</p><ul><li>cookies niezbędne do prawidłowego działania strony,</li><li>cookies analityczne pomagające analizować ruch na stronie,</li><li>cookies funkcjonalne poprawiające komfort korzystania z serwisu.</li></ul>"
            }, {
              title: "Prywatność danych w formularzach",
              description: "Twój numer telefonu oraz inne dane wpisane w formularzu kontaktowym są wykorzystywane wyłącznie do udzielenia odpowiedzi na Twoje zapytanie. <strong>Nie udostępniamy tych danych osobom trzecim</strong> ani nie wykorzystujemy ich do celów marketingowych bez Twojej wyraźnej zgody."
            }, {
              title: "Zarządzanie cookies",
              description: "Użytkownik może w każdej chwili zmienić ustawienia dotyczące plików cookies w swojej przeglądarce internetowej lub usunąć zapisane pliki cookies.Ograniczenie stosowania cookies może wpłynąć na niektóre funkcje dostępne na stronie internetowej."
            }, {
              title: "Dane kontaktowe",
              description: "W przypadku pytań dotyczących naszych zasad korzystania z plików cookie, prosimy o kontakt poprzez formularz na stronie, lub skontaktuj się z nami: <br><strong>Sunny Isles Sp. z o.o. <br> e-mail: sunnyisles.lub@gmail.com <br> <a href='https://www.inewera.pl'>www.inewera.pl</a></strong>."
            }]
          },
          guiOptions: {
            consentModal: {
            ...
            preferencesModal: {
              ...
              // Вікно налаштувань
              position: "right",
              // Відкривається справа
              equalWeightButtons: true
            }
          },
          // Це налаштування дозволяє показувати кнопку виклику після згоди
          disablePageInteraction: false

          // Щоб кнопка з'явилася автоматично (у v3 це часто робиться через CSS/HTML)
        }
      }
    }
  });
  document.addEventListener("click", e => {
    // Шукаємо, чи клікнули по самому щиту або по іконці всередині нього
    const btn = e.target.closest('[data-cc="show-preferences"]');
    if (btn) {
      e.preventDefault();
      Object(_services_cookieconsent_esm_js__WEBPACK_IMPORTED_MODULE_0__["showPreferences"])(); // Виклик вікна налаштувань
    }
  });
}
...
/* harmony import */ var _modules_coockies__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/coockies */ "./src/js/modules/coockies.js");
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  Object(_modules_coockies__WEBPACK_IMPORTED_MODULE_12__["default"])();
});

/***/ }),

/***/ "./src/js/services/cookieconsent.esm.js":
/*!**********************************************!*\
  !*** ./src/js/services/cookieconsent.esm.js ***!
  \**********************************************/
/*! exports provided: acceptCategory, acceptService, acceptedCategory, acceptedService, eraseCookies, getConfig, getCookie, getUserPreferences, hide, hidePreferences, loadScript, reset, run, setCookieData, setLanguage, show, showPreferences, validConsent, validCookie */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "acceptCategory", function() { return Ve; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "acceptService", function() { return Le; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "acceptedCategory", function() { return Ie; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "acceptedService", function() { return je; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "eraseCookies", function() { return Pe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getConfig", function() { return Qe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCookie", function() { return Ke; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUserPreferences", function() { return Ue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hide", function() { return Re; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "hidePreferences", function() { return $e; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadScript", function() { return ze; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "reset", function() { return Ye; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "run", function() { return Xe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setCookieData", function() { return qe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setLanguage", function() { return Je; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "show", function() { return Oe; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showPreferences", function() { return Be; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validConsent", function() { return We; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "validCookie", function() { return Fe; });
/*!
* CookieConsent 3.1.0
...
const Je = async (e, t) => {
  ...
  Ye = e => {
    ...
    for (const {
      ...
      ge: t,
      me: o
    } of g.o.m) e.removeEventListener(t, o);
...
function filterData(letter, arr) {
  const filtered = arr.filter(o => o.phone.startsWith(letter));
  const names = filtered.map(o => o.phone);
  const catalogs = filtered.filter(o => o.catalogs).flatMap(o => o.catalogs);
  const listContainer = document.querySelector(".brendy__list");
  ...
  if (catalogs.length) {
    ...
    catalogs.forEach(catalog => {
      ...
      li.innerHTML = `<a href="${catalog}" target="_blank">${catalog.split("/").pop()}</a>`;
