...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/new.js");
/******/ })
/************************************************************************/
/******/ ({
...
function loopFix(_temp) {
  ...
  if (slides.length < slidesPerView + loopedSlides || swiper.params.effect === 'cards' && slides.length < slidesPerView + loopedSlides * 2) {
    Object(_utils_mjs__WEBPACK_IMPORTED_MODULE_1__["u"])('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var swiper_swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/swiper */ "./node_modules/swiper/swiper.mjs");
/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/modules */ "./node_modules/swiper/modules/index.mjs");
/* harmony import */ var _services_const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/const */ "./src/js/services/const.js");
...
/* harmony import */ var _services_resize_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/resize.js */ "./src/js/services/resize.js");
/* harmony import */ var _services_changeDomElements_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/changeDomElements.js */ "./src/js/services/changeDomElements.js");
/* harmony import */ var _services_scroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/scroll.js */ "./src/js/services/scroll.js");
...
/* harmony import */ var _services_clickFunctions_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/clickFunctions.js */ "./src/js/services/clickFunctions.js");
...
document.addEventListener("DOMContentLoaded", () => {
  Object(_services_changeDomElements_js__WEBPACK_IMPORTED_MODULE_3__["changeDonecTextarea"])();
  Object(_services_changeDomElements_js__WEBPACK_IMPORTED_MODULE_3__["changeTitleModal"])();
  Object(_modules_slider_js__WEBPACK_IMPORTED_MODULE_0__["default"])(".new-slider__swiper-container");
  Object(_modules_preloader_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_services_resize_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_services_changeDomElements_js__WEBPACK_IMPORTED_MODULE_3__["changeDonecTextarea"], _services_changeDomElements_js__WEBPACK_IMPORTED_MODULE_3__["changeTitleModal"], _services_changeDomElements_js__WEBPACK_IMPORTED_MODULE_3__["changeTelMail"]);
  Object(_services_scroll_js__WEBPACK_IMPORTED_MODULE_4__["default"])(() => Object(_modules_menu_js__WEBPACK_IMPORTED_MODULE_5__["default"])("modifikator"));
  Object(_services_click_js__WEBPACK_IMPORTED_MODULE_6__["default"])(e => Object(_services_clickFunctions_js__WEBPACK_IMPORTED_MODULE_7__["hamburgerClick"])(e, "modifikator"), _services_clickFunctions_js__WEBPACK_IMPORTED_MODULE_7__["requestClick"]);
});
...
//     (book) => book.year > 2000 && book.genre == "Science Fiction"
// );
...
// const users = [
//     {id: 1, name: "Anna", city: "Vienna", isActive: true},
//     {id: 2, name: "Max", city: "Berlin", isActive: false},
//     {id: 3, name: "Lena", city: "Munich", isActive: true},
//     {id: 4, name: "Tom", city: "Berlin", isActive: true},
//     {id: 5, name: "Sara", city: "Berlin", isActive: true},
...
//
// const transactions = [
//     {userId: 1, amount: 50, date: "2025-04-01"},
//     {userId: 2, amount: 30, date: "2025-04-02"},
//     {userId: 1, amount: 100, date: "2025-04-15"},
//     {userId: 3, amount: 200, date: "2025-03-25"},
//     {userId: 2, amount: 150, date: "2025-03-29"},
//     {userId: 1, amount: 25, date: "2025-03-10"},
// ];
//
// const num = '+380977337474';
// const code = '+380';
//
//
// function getNum(code, number) {
//     const getCode = number.slice(0, code.length);
//     const getNum = number.slice(-9);
//     console.log(getCode, getNum);
// }
//
// getNum(code, num);
//
...
//
//     Преобразует его в строку формата JSON.
//
//     Парсит полученную строку обратно в объект.
//
//     Возвращает результат парсинга, но только с преобразованными значениями: все строки
// должны быть приведены к верхнему регистру.
...
// Напиши функцию groupByKey(arr, key), которая принимает массив объектов и строку key, а
// затем возвращает новый объект, где ключи — это уникальные значения из свойства key
// каждого объекта, а значениями будут массивы всех объектов, у которых это свойство
// равно соответствующему ключу
...
// У вас есть массив чисел. Нужно с помощью метода .reduce() найти среднее арифметическое этих чисел.
const numbers = [10, 20, 30, 40, 50];
let result2 = numbers.reduce((acc, num) => acc + num, 0) / numbers.length;
console.log(result2); // 30

// У вас есть массив объектов, каждый из которых содержит информацию о товаре: название и цена. Нужно с помощью метода .reduce() найти сумму цен всех товаров в массиве.
const items = [{
  name: "Apple",
  price: 1.2
}, {
...
console.log(totalPrice); // 5.5

// У вас есть массив строк, в которых указаны имена людей. Нужно с помощью метода .reduce() создать объект, который будет содержать количество появлений каждого имени в массиве.

const names = ["Alice", "Bob", "Alice", "Charlie", "Bob", "Alice"];
let num = names.reduce((acc, name) => {
  if (!acc[name]) {
    acc[name] = 0;
  }
  acc[name] = acc[name] + 1;
...
// У вас есть массив объектов, где каждый объект представляет заказ с количеством товара и его ценой. Нужно с помощью метода .reduce() посчитать общую стоимость всех заказов.
...
const sum = orders.reduce((acc, order) => acc + order.quantity * order.price, 0);
console.log(sum); // 4100

// У вас есть массив объектов, где каждый объект представляет человека с его возрастом. Нужно с помощью метода .reduce() найти средний возраст всех людей.
...
const mean = people.reduce((acc, person) => acc + person.age, 0) / people.length;
console.log(mean); // 32.5
