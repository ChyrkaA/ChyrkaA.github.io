...
/* harmony import */ var _services_esm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/+esm */ "./src/js/services/+esm.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Swiper", function() { return J; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return J; });
/**
 * Bundled by jsDelivr using Rollup v2.79.2 and Terser v5.37.0.
 * Original file: /npm/swiper@11.2.6/swiper.mjs
 *
...
function y(e) {
  return void 0 === e && (e = {}), T || (T = function (e) {
    ...
    const u = a.match(/(iPod)(.*OS\s([\d_]+))?/),
      ...
      h = "Win32" === r;
    let m = "MacIntel" === r;
    return !p && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${d}`) >= 0 && (p = a.match(/(Version)\/([\d.]+)/), p || (p = [0, 1, "13_0_0"]), m = !1), c && !h && (o.os = "android", o.android = !0), (p || f || u) && (o.os = "ios", o.ios = !0), o;
  }(e)), T;
}
function E() {
  return b || (b = function () {
...
const I = (e, t) => {
  ...
  k = e => {
    ...
    if (e.params.rewind || e.params.loop) for (let i = r - t; i <= n + t; i += 1) {
      const t = (i % s + s) % s;
      (t < r || t > n) && L(e, t);
    } else for (let i = Math.max(r - t, 0); i <= Math.min(n + t, s - 1); i += 1) i !== r && (i > n || i < r) && L(e, i);
  };
var O = {
  updateSize: function () {
    const e = this;
  ...
  updateSlides: function () {
    ...
    for (let i = 0; i < u; i += 1) {
      let r;
      if (I = 0, c[i] && (r = c[i]), C && e.grid.updateSlide(i, r, c), !c[i] || "none" !== v(r, "display")) {
        if ("auto" === s.slidesPerView) {
          L && (c[i].style[e.getDirectionLabel("width")] = "");
          const n = getComputedStyle(r),
            a = r.style.transform,
            o = r.style.webkitTransform;
          if (a && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), s.roundLengths) I = e.isHorizontal() ? w(r, "width", !0) : w(r, "height", !0);else {
            const e = t(n, "width"),
              s = t(n, "padding-left"),
              i = t(n, "padding-right"),
              a = t(n, "margin-left"),
            ...
            if (l && "border-box" === l) I = e + a + o;else {
              const {
                clientWidth: t,
                offsetWidth: n
              } = r;
        ...
        c[i] && (c[i].swiperSlideSize = I), g.push(I), s.centeredSlides ? (E = E + I / 2 + M / 2 + y, 0 === M && 0 !== i && (E = E - n / 2 - y), 0 === i && (E = E - n / 2 - y), Math.abs(E) < .001 && (E = 0), s.roundLengths && (E = Math.floor(E)), P % s.slidesPerGroup == 0 && h.push(E), m.push(E)) : (s.roundLengths && (E = Math.floor(E)), (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup == 0 && h.push(E), m.push(E), E = E + I + y), e.virtualSize += I + y, M = I, P += 1;
      }
    }
    if (e.virtualSize = Math.max(e.virtualSize, n) + T, a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize + y}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize + y}px`), C && e.grid.updateWrapperSize(I, h), !s.centeredSlides) {
      const t = [];
    ...
    if (l && s.loop) {
      ...
      for (let i = 0; i < e.virtual.slidesBefore + e.virtual.slidesAfter; i += 1) 1 === s.slidesPerGroup && h.push(h[h.length - 1] + t), m.push(m[m.length - 1] + t), e.virtualSize += t;
    }
    ...
    if (u !== d && e.emit("slidesLengthChange"), h.length !== b && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), m.length !== x && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit("slidesUpdated"), !(l || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
  ...
  updateSlidesProgress: function (e) {
    ...
    for (let e = 0; e < i.length; e += 1) {
      ...
      m && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)), P(l, m, s.slideVisibleClass), P(l, h, s.slideFullyVisibleClass), l.progress = r ? -c : c, l.originalProgress = r ? -p : p;
    }
  },
...
var G = {
  slideTo: function (e, t, s, i, r) {
    ...
    if (n.initialized && a !== p) {
      if (!n.allowSlideNext && (f ? w > n.translate && w > n.minTranslate() : w < n.translate && w < n.minTranslate())) return !1;
    ...
    if (!(T && r) && (f && -w === n.translate || !f && w === n.translate)) return n.updateActiveIndex(a), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(w), "reset" !== S && (n.transitionStart(s, S), n.transitionEnd(s, S)), !1;
    if (o.cssMode) {
      const e = n.isHorizontal(),
        s = f ? w : -w;
...
var _ = {
  ...
  loopFix: function (e) {
    ...
    if (d.__preventObserver__ = !0, requestAnimationFrame(() => {
    ...
    }), "cards" === d.params.effect && c.length < w + 2 * T && (y.includes(n) && y.splice(y.indexOf(n), 1), x.includes(n) && x.splice(x.indexOf(n), 1)), I && x.forEach(e => {
    ...
    }), d.recalcSlides(), "auto" === m.slidesPerView ? d.updateSlides() : b && (x.length > 0 && I || y.length > 0 && C) && d.slides.forEach((e, t) => {
      ...
      l ? d.setTranslate(d.translate - t) : (d.slideTo(P - k, 0, !1, !0), r && (d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t, d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t));
    } else {
...
function B(e) {
  ...
  r.allowTouchCallbacks && s.emit("touchMove", p), a.previousX = a.currentX, a.previousY = a.currentY, a.currentX = u, a.currentY = f;
  const h = a.currentX - a.startX,
    m = a.currentY - a.startY;
  if (s.params.threshold && Math.sqrt(h ** 2 + m ** 2) < s.params.threshold) return;
  if (void 0 === r.isScrolling) {
    let e;
    s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? r.isScrolling = !1 : h * h + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(h)) / Math.PI, r.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle);
  }
...
function N(e) {
  ...
  for (let e = 0; e < c.length; e += e < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
    ...
    void 0 !== c[e + t] ? (m || h >= c[e] && h < c[e + t]) && (v = e, g = c[e + t] - c[e]) : (m || h >= c[e]) && (v = e, g = c[c.length - 1] - c[c.length - 2]);
  }
  let w = null,
    S = null;
...
const U = {
    ...
    events: {
      attachEvents: function () {
        ...
        e.onTouchStart = V.bind(e), e.onTouchMove = B.bind(e), e.onTouchEnd = N.bind(e), e.onDocumentTouchStart = j.bind(e), t.cssMode && (e.onScroll = H.bind(e)), e.onClick = $.bind(e), e.onLoad = R.bind(e), W(e, "on");
      },
    ...
    breakpoints: {
      setBreakpoint: function () {
        ...
        const u = (p in a ? a[p] : void 0) || e.originalParams,
          ...
          v = u.grabCursor,
          g = r.enabled;
        f && !h ? (n.classList.remove(`${r.containerModifierClass}grid`, `${r.containerModifierClass}grid-column`), e.emitContainerClasses()) : !f && h && (n.classList.add(`${r.containerModifierClass}grid`), (u.grid.fill && "column" === u.grid.fill || !u.grid.fill && "column" === r.grid.fill) && n.classList.add(`${r.containerModifierClass}grid-column`), e.emitContainerClasses()), m && !v ? e.unsetGrabCursor() : !m && v && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach(t => {
...
class J {
  constructor() {
    ...
    }), o.browser = E(), o.eventsListeners = {}, o.eventsAnyListeners = [], o.modules = [...o.__modules__], t.modules && Array.isArray(t.modules) && o.modules.push(...t.modules);
    const l = {};
    o.modules.forEach(e => {
      e({
        params: t,
