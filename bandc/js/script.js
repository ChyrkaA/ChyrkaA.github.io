...
alert('Давай пограємо в гру Бики и корови!');
	...
	if (num >= 100 && num <= 9999) {
		...
		for (let i = 0; i < arr2.length; i++) {
			...
			for (let j = i + 1; j < arr2.length; j++) {
				if (cache === arr2[j]) {
					alert("Деякі цифри у введеному числі - повторюються. Будьте уважнішим(ою)!");
					return;
				}				
			}			
		}
	} else {
		alert("Число має бути в діапазоні від 0*** до 9999, будьте уважнішим(ою)!");
		return;
	}
	proverka(arr, arr2);
}
